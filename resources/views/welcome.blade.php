            ...
            <div class="content">
                <!-- <div class="form-group row"> -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="last_name" name="last_name" 
                        required v-model="newItem.last_name" placeholder=" Enter some lst name">
                  </div>
                  <div class="form-group">
                ...
                <div class="table table-borderless" id="table">
                    <table class="table table-borderless" id="table">
                        ...
                        <tr v-for="item in items">
                            ...
                            <td id="show-modal" @click="showModal=true; setVal(item.id, item.name, item.last_name,item.age, item.profession)"  class="btn btn-info" ><span
                ...
                <modal v-if="showModal" @close="showModal=false">
                    ...
                    <div slot="body">
                        ...
                        Last Name: <input type="text" class="form-control" id="e_last_name" name="last_name"
                                required  :value="this.e_last_name">
