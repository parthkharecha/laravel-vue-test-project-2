...
var app = new Vue({
  ...
  data: {
    ...
    e_id: '',
    e_profession: '',
    newItem: { 'name': '','last_name': '','age': '','profession': '' },
   },
  ...
  methods: {
    ...
    setVal(val_id, val_name, val_last_name,val_age, val_profession) {
        this.e_id = val_id;
    ...
    createItem: function createItem() {
      ...
      if (input['name'] == ''|| input['last_name'] == '' || input['age'] == '' || input['profession'] == '' ) {
        this.hasError = false;
      } else {
        this.hasError = true;
        axios.post('/vueitems', input).then(function (response) {
          _this.newItem = { 'name': '', 'last_name': '', 'age': '', 'profession': '' };
          _this.getVueItems();
        });
    ...
    editItem: function(){
      console.log(e_id);
      console.log(e_name);
      console.log(e_last_name);
      console.log(e_age);
      console.log(e_profession);

         var i_val_1 = document.getElementById('e_id');
         var n_val_1 = document.getElementById('e_name');
         var l_val_1 = document.getElementById('e_last_name');
         var a_val_1 = document.getElementById('e_age');
         var p_val_1 = document.getElementById('e_profession');

          axios.post('/edititems/' + i_val_1.value, {val_1: n_val_1.value, val_2: a_val_1.value,val_3: p_val_1.value, val_4: l_val_1.value })
            .then(response => {
